        ...
        <div>
            ...
            <div className='divparent'>
                <div className='leftcat'>
                    <h2 className='h2topname'>Fitness</h2>
                    <hr className='hrredline'></hr>
                    {datas.filter((item) => item.category === "fitness" && item.id >= 46 && item.id <= 52).map((item, index) => {
                        return (
                            <div key={index}>
                ...
                <div className='rightcat'>
                    ...
                    <hr className='hrredline'></hr>
                    {datas.filter((item) => item.id === 53).map((item, index) => {
                        return (
                            <div key={index}>
                                <Link style={{ textDecoration: "none", color: "black" }} to={'/news/' + item.id} state={item.id}>
                    ...
                    {/* {datas.filter((item) => item.id >= 54 && item.id < 57).map((item, index) => {
                        return (
                            <div key={index}>
                                <Link style={{ textDecoration: "none", color: "black" }} to={'/news/' + item.id} state={item.id}>
